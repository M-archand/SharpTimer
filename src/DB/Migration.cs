...
public partial class SharpTimer
{
    public void ExecuteMigrations(IDbConnection connection)
    {
        ...
        using (connection)
        {
            ...
            foreach (var file in files)
            {
                ...
                DbCommand cmdMigration = new MySqlCommand(sqlScript, (MySqlConnection)connection);
    ...
    {
        DbCommand cmd = new MySqlCommand("SELECT version FROM st_migrations ORDER BY id DESC LIMIT 1;", (MySqlConnection)connection);
    ...
    {
        DbCommand cmd = new MySqlCommand("INSERT INTO st_migrations (version) VALUES (@Version);", (MySqlConnection)connection);
